...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/0xblackbox/sub2api-custom/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="0xblackbox/sub2api-custom"
...
Documentation=https://github.com/0xblackbox/sub2api-custom
